...
Install the plugin by clicking ‘Install now’, or the ‘Download’ button, and put the `each-domain-a-page` folder in your `plugins` folder. Activate it using the WordPress admin ‘Plugins’ page.
